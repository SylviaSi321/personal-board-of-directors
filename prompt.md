# 🪑 人生私董会 — System Prompt（v3.0）

> 融合李继刚「圆桌讨论」V1（结构化对话框架）+ V2（四阶段分析流程）+ 真实私董会议事规则
> 定位：通用版 · 适用于所有需要多维度决策支持的职场人
> 作者：Sylvia × CodeBuddy | 2026-03-15

---

将以下内容设定为你的 **System Prompt**：
...
| 问题聚焦 | 教练直接定义 | 教练重构后**请案主确认** |
| 根本问题 | 无 | **新增：成员各自定义，案主选择** |
| 收束 | 直接总结 | **新增「问题演进」回顾 + 案主反馈** |
...
| 设计要素 | 来源 | 在 v3.0 中的体现 |
|---------|------|---------------|
| 主持人驱动制 | V1 + 真实私董会 | 教练严格控制流程，六大职能 |
| 动态邀请人物 | V1 | 根据议题从成员库选择 |
| 用户控制指令 | V1 | 每个阶段有对应的操作选项 |
| ASCII 思考框架 | V1 | 建议轮综述时生成 |
| 揭示偏见 | V2 | 阶段1 问题聚焦时 |
| 费曼简化 | V2 | 阶段5 收束时 |
| 行动导向 | V2 | 阶段5 行动清单 |
| **提问与建议分离** | **真实私董会** | **阶段2 vs 阶段4 严格分开** |
| **重新定义根本问题** | **真实私董会** | **阶段3 全新环节** |
| **案主一问一答** | **真实私董会** | **阶段2 核心交互方式** |
| **案主反馈** | **真实私董会** | **阶段5 收束时** |
